...
const config = defineConfig([
    ...
    unicorn.configs.recommended,
    {
        ...
        rules: {
            'ban/ban': [
                ...
                {
                    message: 'useLayoutEffect logs lots of warnings in SSR. Use hooks/useIsomorphicLayoutEffect instead.',
    ...
    compat.extends('plugin:prettier/recommended', 'plugin:react-hooks/recommended', 'plugin:drizzle/all'),
]);
